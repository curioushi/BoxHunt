...
class StorageManager:
    ...
    def save_image_metadata(self, metadata_list: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            if os.path.exists(self.metadata_file):
                ...
                df_new.to_csv(self.metadata_file, mode='a', header=False, 
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stats['total_size'] = df['file_size'].sum() if 'file_size' in df.columns else 0
        ...
        try:
            ...
            if os.path.exists(Config.IMAGES_DIR):
                for filename in os.listdir(Config.IMAGES_DIR):
                    if any(filename.lower().endswith(f'.{ext}') for ext in Config.ALLOWED_FORMATS):
    ...
    def export_metadata(self, output_file: str = None, 
        ...
        try:
            ...
            if output_file is None:
                ...
                output_file = os.path.join(Config.DATA_DIR, f"metadata_export_{timestamp}.{format}")
